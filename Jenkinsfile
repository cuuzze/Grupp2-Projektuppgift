    ...
    stages{
        stage('Run Jmeter tests') {
            steps {
             ...
             bat 'C:\\tools\\apache-jmeter-5.4.1\\apache-jmeter-5.4.1\\bin\\jmeter.bat -Jjmeter.save.saveservice.output_format=xml -n -t C:\\tools\\apache-jmeter-5.4.1\\apache-jmeter-5.4.1\\bin\\PrestaShopReq2.jmx -l jmeter_report.jtl'
